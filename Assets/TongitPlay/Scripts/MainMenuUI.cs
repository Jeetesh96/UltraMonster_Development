...
public class MainMenuUI : MonoBehaviourPunCallbacks {
	...
	public IEnumerator RequestUserRegistration(){
		...
		WWW w = new WWW ("http://65.1.1.23/gameserver/gameserver/action_update_data.php", form);
		yield return w;
		Debug.Log (w.text);
	}
	void Start () {
    ...
    IEnumerator GetFriends()
    {
        ...
        WWW w = new WWW("http://65.1.1.23/gameserver/gameserver/get_all_friends.php", form);
        yield return w;
